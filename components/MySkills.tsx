...
const tagSphereItems: Array<string | ReactNode> = [
	<Image layout='fill' src={ReactLogo} key={1} alt='image' />,
	<Image layout='fill' src={GitIcon} key={2} alt='image' />,
	<Image layout='fill' src={NextIcon} key={3} alt='image' />,
	<Image layout='fill' src={MongoIcon} key={4} alt='image' />,
	<Image layout='fill' src={JavaIcon} key={5} alt='image' />,
	<Image layout='fill' src={JavaScriptIcon} key={6} alt='image' />,
	<Image layout='fill' src={NodeIcon} key={7} alt='image' />,
	<Image layout='fill' src={PhpIcon} key={8} alt='image' />,
	<Image layout='fill' src={PythonIcon} key={9} alt='image' />,
	<Image layout='fill' src={TypeScriptIcon} key={10} alt='image' />,
	<Image layout='fill' src={SassIcon} key={11} alt='image' />,
];
